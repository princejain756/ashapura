...
export const About: React.FC = () => {
    ...
    return (
        <div className="pt-20 bg-art-cream min-h-screen">
            <SEO
                title="About — Ashapura Art Studio"
                description="Learn about Ashapura Art Studio (purnaa.store) and the artist behind the collections. Discover our story, values, awards, and how we create premium art and corporate gifting experiences."
                keywords="about ashapura art studio, pallavi jain, hyderabad artist, corporate gifting, spiritual art, awards, ashapura studio, purnaa.store"
                image="/logoweb.webp"
                type="website"
            />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-4 sm:space-y-5 text-art-charcoal/80 text-base sm:text-lg leading-relaxed font-light">
                            ...
                            <p>
                                Through <strong className="text-art-green font-medium">Ashapura Art Studio</strong> — her GST registered firm — Pallavi offers original paintings, murals, hand-painted décor, and custom artworks that touch hearts and elevate everyday spaces (official website: <strong className="text-art-green font-medium">purnaa.store</strong>).
                            </p>
                        </div>
            ...
            <Section>
                ...
                >
                    <div className="text-center mb-12">
                        ...
                        <h3 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-art-green">Ashapura Art Studio</h3>
