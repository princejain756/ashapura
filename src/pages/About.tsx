        ...
        <div className="pt-20 bg-art-cream min-h-screen">
            ...
            <Section>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h4 className="text-art-gold font-serif text-lg tracking-widest mb-2">🌿 ABOUT ME</h4>
                        <h1 className="text-4xl lg:text-5xl font-serif text-art-green mb-4">A Journey Through Colors and Consciousness</h1>

                        <div className="space-y-5 text-art-charcoal/80 text-lg leading-relaxed font-light">
                            <p>
                        ...
                        <div className="mt-10 grid grid-cols-2 gap-8">
                            <div>
                                <h3 className="text-4xl font-serif text-art-green mb-2">800+</h3>
                                <p className="text-sm uppercase tracking-widest text-art-gold">Artworks Sold</p>
                            </div>
                            <div>
                                <h3 className="text-4xl font-serif text-art-green mb-2">6+</h3>
                                <p className="text-sm uppercase tracking-widest text-art-gold">Years Journey</p>
                            </div>
                        </div>
                    </motion.div>
                </div>
            ...
            <Section background="alt">
                ...
                >
                    <h2 className="text-art-gold font-serif text-lg tracking-widest mb-2 text-center">🌿 MY STORY</h2>
                    <h3 className="text-4xl lg:text-5xl font-serif text-art-green mb-8 text-center">Colors, Courage, and a Mother's Journey</h3>
                    <p className="text-center text-art-charcoal/60 italic mb-12">— Pallavi Jain</p>

                    <div className="space-y-6 text-art-charcoal/80 text-lg leading-relaxed font-light">
                        <p>
            ...
            <Section>
                ...
                >
                    <div className="text-center mb-12">
                        <h2 className="text-art-gold font-serif text-lg tracking-widest mb-2">🏛️ COMPANY PROFILE</h2>
                        <h3 className="text-4xl lg:text-5xl font-serif text-art-green">Ashapura Studio</h3>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-xl border-t-4 border-art-gold">
            ...
            <Section background="alt" id="awards">
                ...
                >
                    <div className="text-center mb-12">
                        <h2 className="text-art-gold font-serif text-lg tracking-widest mb-2">🏆 RECOGNITION</h2>
                        <h3 className="text-4xl lg:text-5xl font-serif text-art-green">Awards & Achievements</h3>
                    </div>
            ...
            <Section background="default">
                ...
                >
                    <h2 className="text-4xl font-serif text-art-green mb-8">Connect with Pallavi</h2>
                    ...
                    <div className="flex flex-wrap justify-center gap-6 mb-10">
                        <a
                            ...
                            className="flex items-center gap-2 bg-white px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-shadow hover:bg-art-gold/10"
                        >
                            <Instagram className="text-art-green" size={24} />
                            <span className="text-art-charcoal">@ashapura_art_studio</span>
                        </a>
                        <a
                            ...
                            className="flex items-center gap-2 bg-white px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-shadow hover:bg-art-gold/10"
                        >
                            <Linkedin className="text-art-green" size={24} />
                            <span className="text-art-charcoal">Pallavi Bhandari Jain</span>
                        </a>
                        <a
                            ...
                            className="flex items-center gap-2 bg-white px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-shadow hover:bg-art-gold/10"
                        >
                            <Facebook className="text-art-green" size={24} />
                            <span className="text-art-charcoal">Ashapura Art Studio</span>
                        </a>
                    </div>

                    <div className="flex flex-wrap justify-center gap-8 text-art-charcoal/80">
