            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-24">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 text-center sm:text-left">
                    ...
                    <div className="flex flex-col items-center sm:items-start space-y-3 sm:space-y-4 sm:col-span-2 md:col-span-1">
                        <img src="/logoweb.webp" alt="Ashapura Art Studio" className="h-16 w-auto brightness-0 invert opacity-80" />
                        <p className="text-art-cream/80 text-sm max-w-xs leading-relaxed">
                            Ashapura Art Studio (purnaa.store) curates spiritual & contemporary art by Pallavi Jain, plus premium corporate gifting collections. Transforming spaces into sanctuaries of color, consciousness, and calm.
                        </p>
